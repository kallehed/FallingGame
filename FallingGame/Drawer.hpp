...
public:
    ...
    void draw_star(float x, float y, float scale, float filled);
...
private:
    ...
    unsigned int _star_program = 0;
    unsigned int _star_VAO;
    int _star_u_offset_width_height, _star_u_filled;
